...
source(paste(DirCode,'/code/mti experiment main code/resulttable.R',sep=''))
...
Title="Theil's U (and ranking) for all models included in MCS, recession"
source(paste(DirCode,'/code/mti experiment main code/resulttable.R',sep=''))
writeLines(out,paste(DirCode,'/tables/crisisperiods.tex',sep=''))
# t3=read.csv(paste(DirCode,'/test.txt',sep=''),sep='&')
