...
for (vint.num in 1:length(sets)){# vint.num=1
        ...
        nom.var=c('HWWA','HWWA-E','HWWA-EX','OIL')
        set[,deflated.var]=set[,nom.var]*deflator
        
        # PUBLICATION LAG of unrevised data (no deflated data need to be lagged further)
        ...
        # DIFFERENCES
        variables.d=row.names(overview)[!is.na(overview$L)]
        ...
        # DROP LEVEL data that is not needed
        # AR-REGRESSORS: are set dln need to be taken out of the rest of variables.
        # dependent: dln y with d being bridging the forecast horizon.
        # horizon might change from vintage to vintage. need to check and adjust.
