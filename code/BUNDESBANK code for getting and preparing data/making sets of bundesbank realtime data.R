...
var.order=var.order[-which(var.order$variable=='M.DE.Y.I.IO1.ABA20.C.I'),]
var.used=var.order
...
var.used=rbind(var.used,var.employ)
# wage
...
var.used$label=c('ORD-I','ORD-C','CPI-EX','CPI','WHOUR','EW','TARIF','IP-VORL','IP-CONST','IP')
var.used$transformation=c('Dln','Dln','D ln, DD ln','D ln, DD ln','L, D','D ln','D ln, DD ln','Dln','Dln','Dln')
# variables used
nvar=nrow(var.used)
