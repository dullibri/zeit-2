...
t6=read.csv(paste(dir,'/finaldata/',dataf[6],sep=''))
...
t=t6[,(grep('ym',colnames(t6))+1):ncol(t6)]
data[,colnames(t6)[(grep('ym',colnames(t6))+1):ncol(t6)]]=NA
data[data$ym%in%t6$ym,colnames(t6)[(grep('ym',colnames(t6))+1):ncol(t6)]]=t6[,(grep('ym',colnames(t6))+1):ncol(t6)]
...
t=t4[,(grep('X',colnames(t4))+1):ncol(t4)]
data[,colnames(t4)[(grep('X',colnames(t4))+1):ncol(t4)]]=NA
data[data$ym%in%t4$X,colnames(t4)[(grep('X',colnames(t4))+1):ncol(t4)]]=t4[,(grep('X',colnames(t4))+1):ncol(t4)]
