...
indexrel=data.frame(qdap_rel_val_total=indexrel[,2]/ns)
...
total[,'qdap_value_rel_infl']=total[,'qdap_value_ampl']/total[,'qdap_nword']*total$InflationMutationen
indexrel[,paste('qdap_value_rel_infl','_mean',sep='')]=aggregate(total[,'qdap_value_rel_infl'],list(as.factor(total$ym)),mean,na.rm=T)[,2]
