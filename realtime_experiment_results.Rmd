...
#         forecasts=forecasts[1:110,,drop=F]
...
# print(paste('Horizon: ',horizon,sep=''))
#         paste('Horizon: ',horizon,sep='')
        kable(result.focus(target,horizon,rolling_window), format = "pandoc",caption=paste('Forecasted variable: ',target,', horizon: ',horizon,sep=''))
        }
```
